<div class="container bg-secondary py-2 py-lg-0 mb-3 mt-3">
    <div class="row">
        <div id="sliderNews" style="height: 450px" class="carousel slide col-md-12 col-lg-9 pl-lg-0"
            ...
            <div class="carousel-inner" style="height: 100%" role="listbox">
                ...
                <?php foreach ($slider as $slide):
                    ...
                    ?>
                    <div class="h-100 carousel-item <?php echo $count == 0 ? 'active' : '' ?>"
                         data-slide-id="<?php echo $slide->ID ?>">
                        <div class="h-100 d-flex align-items-center ">
                            <img class="justify-content-center align-self-center mx-auto img-fluid"
        ...
        <div class="news-slider-box col-md-12 col-lg-3 pl-lg-0">
            <?php
            $count = 0;
            foreach ($slider as $slide):
                ...
                ?>
                <div id="<?php echo 'sliderNews' . $slide->ID ?>"
                     class="slide-description d-none <?php echo $count == 0 ? ' d-block' : '' ?>">
                    <div class="bg-light p-2" style="height: 100px">
                        <h5 class="font-weight-bold h-75 pb-2"><?php echo $slide->post_title ?></h5>
                        <p class="pb-2">
                            <span class="small">
                                <?php
                    ...
                    <div class="p-1 news-slider-content">
                        <?php echo $slide->post_content ?>
                    </div>
                    <div class="h-25 text-right align-text-bottom">
                        <?php
                        $meta = get_post_meta($slide->ID, "tro_button_url", true);
                        if (!empty($meta)): ?>
                            <a class="clYellow" href="<?php echo $meta ?>">Czytaj dalej...</a>
                        <?php endif;
                        ?>
