...
if (!function_exists('trendone_get_coauthor_cache')) {
   /**
     * @return TrendOne_CoauthorCache
     */
    function trendone_get_coauthor_cache()
    {
        static $cache;
        if (null == $cache) {
            $cache = new TrendOne_CoauthorCache();
        }
        return $cache;
...
if (!function_exists('trendone_get_category_id')) {
    function trendone_get_category_id()
    {
